...
func (s *GunSuite) Test_FullScenario() {
	...
	s.Require().Equal(`Auth:{Code200:{key:1 value:1} Code200:{key:2 value:1} Code200:{key:3 value:1}} List:{Code200:{key:1 value:1} Code200:{key:2 value:1} Code200:{key:3 value:1}} Order:{Code200:{key:1 value:3} Code200:{key:2 value:3} Code200:{key:3 value:3}}`, statistics)
}
